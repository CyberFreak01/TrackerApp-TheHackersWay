...
public class deviceinfoMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                inp.hideSoftInputFromWindow(editText.getWindowToken(), 0);
                editText.setText("Generating link...");
                cardView.setVisibility(View.VISIBLE);
                String url=link.getText().toString();
                postDataUsingVolley(url,iplogger_url);
                // Shortener("shortlink");
                responseTV.setBackground(ContextCompat.getDrawable(deviceinfoMain.this,R.drawable.iplogger_bg));
    ...
    private void postDataUsingVolley(String link,String url) {
        ...
        RequestQueue queue = Volley.newRequestQueue(deviceinfoMain.this);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(deviceinfoMain.this, "Failed to get Response", Toast.LENGTH_SHORT).show();            }
        }) {
            @Override
    ...
    public void openActx(){
        Intent intentx = new Intent(this, devicedetails.class);
        intentx.putExtra("message_key", id);
